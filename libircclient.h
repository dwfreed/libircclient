...
char *irc_get_nick(struct irc_session *session) __attribute__((__nonnull__));
char *irc_get_username(struct irc_session *session) __attribute__((__nonnull__));
char *irc_get_hostname(struct irc_session *session) __attribute__((__nonnull__));
